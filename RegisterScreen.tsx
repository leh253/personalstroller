...
import { UserFormData, ParentStatus } from './types.ts';
...
const RegisterScreen: React.FC<Props> = ({ onBack, onSuccess }) => {
  ...
  // Fix: Use correct Child interface property name 'ageRange'
  const addChild = () => {
  ...
  // Fix: Update child property to ageRange to match Child interface
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (authData.user) {
        // Fix: Use Minimal PII approach mapping to user_leads table
