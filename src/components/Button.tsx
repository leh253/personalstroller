...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    primary: "bg-gradient-to-r from-[#c5a065] to-amber-600 text-white shadow-[0_8px_20px_rgba(197,160,101,0.3)] hover:shadow-[0_12px_24px_rgba(197,160,101,0.4)] border border-white/20 backdrop-blur-sm",
    // Glassy Outline
    outline: "bg-white/5 border border-white/20 text-[#c5a065] hover:bg-white/10 hover:border-[#c5a065]/50 backdrop-blur-sm",
    // Option Button
